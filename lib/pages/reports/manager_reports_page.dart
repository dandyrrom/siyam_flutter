...
class _MonthlyBarChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: chartHeight + 50, // Increased height to prevent overflow
      child: Row(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (values[i] > 0)
                      Text(
                        '$valuePrefix${values[i] % 1 == 0 ? values[i].toInt() : values[i].toStringAsFixed(1)}',
                      ...
                      const SizedBox(height: 14), // Placeholder for empty values
